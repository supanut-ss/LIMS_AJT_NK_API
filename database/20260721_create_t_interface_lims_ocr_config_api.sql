...
BEGIN
    INSERT INTO dbo.t_interface_lims_ocr_config_api
        (input_ocr_url, input_ocr_file_url, submission_mode, input_ocr_file_field_name,
    ...
    VALUES
        (N'http://localhost:5117/input_ocr', N'http://localhost:5117/input_ocr_file', N'path', N'file',
         N'http://localhost:5117/api/call_back', N'1_Inbound', N'2_Processing', N'3_Success', N'4_Error',
